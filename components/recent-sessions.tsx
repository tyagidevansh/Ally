...
const UtcDateHint = ({
  ...
  return (
    <div className="flex items-center gap-1.5 text-xs text-gray-500 mt-1">
      <span>
        Will show up on:{" "}
        <span className="text-gray-300 font-medium">{utcLabel}</span>
      </span>
      <div className="relative group/tip">
        <Info className="w-3 h-3 cursor-help text-gray-600 hover:text-gray-400" />
        <div
          className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 w-60 p-2.5
            ...
            >
              <div className="flex justify-between items-center">
                <div className="flex gap-2 items-center">
                  ...
                  <div className="flex items-center justify-center rounded-md border border-green-500/40 bg-green-500/10 p-1 opacity-0 group-hover:opacity-100 transition-all duration-150 shadow-[0_0_0_1px_rgba(16,185,129,0.2)] group-hover:shadow-[0_0_10px_rgba(16,185,129,0.35)]">
                    <Pencil className="w-3 h-3 text-green-300" />
                  </div>
                </div>
